...
public class BestPayConfig {
    ...
    public WxPayConfig wxPayConfig() {
        ...
        wxPayConfig.setNotifyUrl("https://zhh.mynatapp.cc/pay/notify");
        wxPayConfig.setReturnUrl("https://www.zhaohaihao.com");
    ...
    public AliPayConfig aliPayConfig() {
        ...
        aliPayConfig.setNotifyUrl("https://zhh.mynatapp.cc/pay/notify");
        // 支付之后, 支付宝跳转的地址
        aliPayConfig.setReturnUrl("https://www.zhaohaihao.com");
